...
def search_tag_reencrypt(response):
    # Takes a describe_db_cluster_snapshots response and searches for our reEncrypt tag,
    # indicating that the snapshot needs to be re-encrypted with a customer-managed key before it can be shared.
    try:
